...
$sheel->template->meta['areatitle'] = 'Admin CP | <div class="type--subdued">External API Manager</div>';
$sheel->template->meta['pagetitle'] = SITE_NAME . ' - Admin CP | External API Manager';

if (!empty($_SESSION['sheeldata']['user']['userid']) and $_SESSION['sheeldata']['user']['userid'] > 0 and $_SESSION['sheeldata']['user']['isadmin'] == '1') {
    $areanav = 'settings_eapi';
    $currentarea = 'External API Manager';
    ...
    $sheel->template->fetch('main', 'settings_eapi.html', 1);
