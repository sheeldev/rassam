...
(function($){
    ...
    $('.btn-toogle,.side-menu').css('opacity','0')
                clearTimeout( $.data( this, "scrollCheck" ) );
                $.data( this, "scrollCheck", setTimeout(function() {
                    $('.btn-toogle,.side-menu').css('opacity','1')
                }, 250) );
   ...
   $(".modal").on("shown.bs.modal", function () {
    ...
    function rep_menu(){
        ...
        $('.toggle-mobile-menu-more').on('click',function(event){
            event.preventDefault();
            $(this).toggleClass('active');
            $('.toggle-mobile-menu-more-option').toggleClass('active');
        });
    }
