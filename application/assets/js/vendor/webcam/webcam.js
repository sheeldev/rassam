...
window.webcam = {
	...
	swf_url: iL['SWFBASE'] + 'webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: iL['MP3BASE'] + 'shutter.mp3', // URI to shutter.mp3 sound
	...
	flash_notify: function(type, msg) {
		...
		switch (type) {
			...
			default:
				...
				alert("iCam flash_notify: " + type + ": " + msg);
				break;
		}
	}
};