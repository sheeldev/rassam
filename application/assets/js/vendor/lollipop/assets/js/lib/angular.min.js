...
(function(O, W, t) {
    ...
    function ka(b, a) {
        ...
        if (c == typeof a && "object" == c)
            if (G(b)) {
                ...
                for (d in a)
                    if (!(d in c || "$" === d.charAt(0) || a[d] === t || C(a[d])))
                        return !1;
                return !0
            }
        return !1
    ...
    function Yd(b, a) {
        var c,
            ...
            e = Qa.length;
        for (d = 0; d < e; ++d)
            if (c = Qa[d] + a, I(c = b.getAttribute(c)))
                return c;
        return null
    }
    function Zd(b, a) {
        ...
        l.url = function(a, c, e) {
            ...
            if (a) {
                ...
                if (!d.history || h && f) {
                    ...
                    n[c ? "replaceState" : "pushState"](e, "", a), g(), p = w;
                return l
            }
                ...
                function g(a, c, d, e) {
                    ...
                    for (n = h.length; r < n;)
                        if (l = N[h[r++]], c = h[r++], f = h[r++], c) {
                            if (c.scope) {
                                if (k = a.$new(), V.$$addScopeInfo(z(l), k), u = c.$$destroyBindings)
            ...
            function E(a, b, d, e, f, g, h, k, r) {
                ...
                function K(a, c, e, f, g, l) {
                    ...
                    for (l = h.length; n < l; n++)
                        p = h[n], $(p, p.isolateScope ? B : c, ja, f, p.require && u(p.directiveName, p.require, ja, A), ha);
                    var ya = c;
                    P && (P.template || null === P.templateUrl) && (ya = B);
                    a && a(ya, e.childNodes, t, g);
                    for (n = k.length - 1; 0 <= n; n--)
                        p = k[n], $(p, p.isolateScope ?
                ...
                for (var J = -Number.MAX_VALUE, S = r.newScopeDirective, w = r.controllerDirectives, P = r.newIsolateScopeDirective, F = r.templateDirective, A = r.nonTlbTranscludeDirective, m = !1, H = !1, s = r.hasElementTranscludeDirective, ba = d.$$element = z(b), E, x, v, y = e, za, wa = 0, L = a.length; wa < L; wa++) {
                    ...
                    if (J > E.priority)
                        break;
                    if (v = E.scope)
                        E.templateUrl || (D(v) ? (O("new/isolated scope", P || S, E, ba), P = E) : O("new/isolated scope",
                        P, E, ba)), S = S || E;
                    x = E.name;
                    !E.templateUrl && E.controller && (v = E.controller, w = w || ga(), O("'" + x + "' controller", w[x], E, ba), w[x] = E);
                    if (v = E.transclude)
                        m = !0, E.$$tlb || (O("transclusion", A, E, ba), A = E), "element" == v ? (s = !0, J = E.priority, v = ba, ba = d.$$element = z(W.createComment(" " + x + ": " + d[x] + " ")), b = ba[0], U(f, xa.call(v, 0), b), y = V(v, e, J, g && g.name, {
                    ...
                    if (E.template)
                        ...
                        E.replace) {
                            ...
                            ba.html(v);
                    if (E.templateUrl)
                        H = !0, O("template", F, E, ba), F = E, E.replace && (g = E), K = Lf(a.splice(wa, a.length - wa), ba, d, f, m && y, h, k, {
    ...
    function Xe() {
        ...
        this.$get = ["$injector", "$window", function(c, d) {
            ...
            return function(f, g, h, l) {
                ...
                if (h)
                    return h = (G(f) ? f[f.length - 1] : f).prototype, k = Object.create(h || null), q && e(g, q, k, n || f.name), Q(function() {
            ...
            function h(f, h, n, q) {
                ...
                for (var p, m, s = 0, H = [], N = [], J = f.length, F = [], V = []; s < J;)
                    if (-1 != (p = f.indexOf(b, s)) && -1 != (m = f.indexOf(a, p + l)))
                        s !== p && F.push(g(f.substring(s, p))), s = f.substring(p + l, m), H.push(s), N.push(c(s, w)), s = m + k, V.push(F.length), F.push("");
                    else {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function(f, g, h, l) {
            ...
            n.prototype = {
                ...
                $watch: function(a, b, c, e) {
                    var f = h(a);
                    if (f.$$watchDelegate)
                        return f.$$watchDelegate(this, b, c, f,
                        a);
                    var g = this,
                        l = g.$$watchers,
                        k = {
                        ...
                        if (!y(e)) {
                            if (D(e))
                                if (Da(e))
                                    ...
                                    a = 0;
                                    for (b in e)
                                        e.hasOwnProperty(b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, d || h === g || (k++, f[b] = g)) : (u++, f[b] = g,
                                        k++));
                                    if (u > a)
                                        for (b in k++, f)
                                    ...
                                    try {
                                        if (b = k[n])
                                            if ((f = b.get(m)) !== (h = b.last) && !(b.eq ? ka(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h)))
                                                r = !0, d = b, b.last = b.eq ? fa(f, null) : f, b.fn(f, h === s ? f : h, m), 5 > u && (E = 4 - u, w[E] || (w[E] = []), w[E].push({
    ...
    function pf() {
        this.$get = ["$window", "$document", function(b, a) {
            var c = {},
                d = Y((/android (\d+)/.exec(M((b.navigator ||
                {}).userAgent)) || [])[1]),
    ...
    function La(b, a, c, d, e) {
        ...
        case "object":
            ...
            if ("object" === g) {
                for (h in a)
                    if (e = a[h], !C(e) && !y(e) && (f = "$" === h, !La(f ? b : b[h], e, c, f, f)))
                        return !1;
                return !0
            }
            return c(b, a);
        ...
        return function(e, f, g, h, l, k, n) {
            ...
            h.$formatters.push(function(a) {
                if (a && !ca(a))
                    throw kb("datefmt", a);
                if (q(a))
                    return (m = a) && u && (m = Ob(m, u, !0)), n("date")(a, d, u);
                m = null;
                return ""
            });
            if (x(g.min) || g.ngMin) {
            ...
            if (d !== Pa && 2 !== d && 8 !== d)
                if (d = M(a), Ab[d])
                    if (x(c))
                        ...
                        return b[a] || (b.attributes.getNamedItem(a) || v).specified ? d : t;
                else if (x(c))
                    b.setAttribute(a, c);
    ...
    eb.$$annotate = function(a, c, d) {
        ...
        if ("function" === typeof a) {
            if (!(e = a.$inject)) {
                ...
                if (a.length) {
                    if (c)
                        throw I(d) && d || (d = a.name || If(a)), Ha("strictdi", d);
    ...
    var xe = ["$animate",
            ...
            this.$$runValidators = function(a, c, d) {
                ...
                (function() {
                    ...
                    if (w === t)
                        ...
                        return w || (m(p.$validators, function(a, c) {
                            g(c, null)
                    ...
                    return function(a, f, g, k, n) {
                        ...
                        a.$watchCollection(q, function(g) {
                            ...
                            if (Da(g))
                                ...
                                for (M in q = p || y, L = [], g)
                                    g.hasOwnProperty(M) && "$" !== M.charAt(0) && L.push(M);
                            D = L.length;
                            M = Array(D);
                            for (k = 0; k < D; k++)
                                if (F = g === L ? k : L[k], I = g[F], G = q(F, I, k), s[G])
                                    H = s[G], delete s[G], C[G] = H, M[k] = H;
                                else {
                                    if (C[G])
                                        throw m(M,
                                        function(a) {
        ...
        Je = Ma({
            ...
            link: function(a, c, d, e, f) {
                if (!f)
                    throw L("ngTransclude")("orphan", ua(c));
                f(function(a) {
                    c.empty();
                    c.append(a)
                })
                ...
                link: function(a, c, d, e) {
                    if (e) {
                        ...
                        d.$observe("pattern", function(a) {
                            ...
                            if (a && !a.test)
                                throw L("ngPattern")("noregexp", g, a, ua(c));
                            f = a || t;
                            e.$validate()
                        });
