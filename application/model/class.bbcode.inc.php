<?php
/**
 * BBCode class to perform the majority of BBcode functions within sheel
 *
 * @package      sheel\BBCode
 * @version      1.0.0.0
 * @author       sheel
 */
class bbcode
{
        ...
        function bbcode_to_html($text = '', $doamperstand = false, $replaceltgt = true)
        {
                ...
                $pattern[] = "#\[table\]#si";
                $replace[] = '<table cellpadding="' . $this->sheel->config['table_cellpadding'] . '" cellspacing="' . $this->sheel->config['table_cellspacing'] . '" border="0" width="100%" dir="' . $this->sheel->config['template_textdirection'] . '">';
                $pattern[] = "#\[\/table\]#si";
                $replace[] = '</table>';
                $pattern[] = "#\[td\]#si";
                $replace[] = '<td>';
